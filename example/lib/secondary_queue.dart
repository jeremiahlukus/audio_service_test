...
class SecondaryQueue extends StatefulWidget {
  ...
  @override
  _SecondaryQueueState createState() => _SecondaryQueueState();
}

class _SecondaryQueueState extends State<SecondaryQueue> {
  @override
  void initState() {
    _setQueue();
    super.initState();
